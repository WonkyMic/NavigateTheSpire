...
public class HandCardSelectScreenPatch2 {
    public static void Postfix (HandCardSelectScreen screen, String msg, int amount, boolean anyNumber, boolean canPickZero)
    {
        if(!canPickZero)
        {
